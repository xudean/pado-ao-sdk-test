...
function abort(what) { if (Module["onAbort"]) {
    Module["onAbort"](what);
} what = "Aborted(" + what + ")"; err(what); ABORT = true; EXITSTATUS = 1; what += ". Build with -sASSERTIONS for more info."; var e = new WebAssembly.RuntimeError(what); throw e; }
...
function createWasm() { var info = { "a": wasmImports }; function receiveInstance(instance, module) { var exports = instance.exports; Module["asm"] = exports; wasmMemory = Module["asm"]["D"]; updateMemoryViews(); wasmTable = Module["asm"]["F"]; addOnInit(Module["asm"]["E"]); removeRunDependency("wasm-instantiate"); } addRunDependency("wasm-instantiate"); function receiveInstantiationResult(result) { receiveInstance(result["instance"]); } function instantiateArrayBuffer(receiver) { return getBinaryPromise().then(function (binary) { return WebAssembly.instantiate(binary, info); }).then(function (instance) { return instance; }).then(receiver, function (reason) { err("failed to asynchronously prepare wasm: " + reason); abort(reason); }); } function instantiateAsync() { if (!wasmBinary && typeof WebAssembly.instantiateStreaming == "function" && !isDataURI(wasmBinaryFile) && !isFileURI(wasmBinaryFile) && !ENVIRONMENT_IS_NODE && typeof fetch == "function") {
...
function _emscripten_resize_heap(requestedSize) { var oldSize = HEAPU8.length; requestedSize = requestedSize >>> 0; return false; }
var ENV = {};
...
FS.FSNode = FSNode;
FS.staticInit();
var wasmImports = { "y": ___cxa_begin_catch, "x": ___cxa_end_catch, "a": ___cxa_find_matching_catch_2, "m": ___cxa_find_matching_catch_4, "w": ___cxa_throw, "c": ___resumeException, "s": ___syscall_getcwd, "z": _abort, "t": _emscripten_memcpy_big, "r": _emscripten_resize_heap, "u": _environ_get, "v": _environ_sizes_get, "p": _fd_write, "q": _getentropy, "B": invoke_dii, "f": invoke_ii, "g": invoke_iii, "i": invoke_iiii, "k": invoke_iiiii, "A": invoke_iiiiii, "C": invoke_iiiiiii, "n": invoke_v, "d": invoke_vi, "b": invoke_vii, "e": invoke_viii, "j": invoke_viiii, "h": invoke_viiiii, "l": invoke_viiiiii, "o": _llvm_eh_typeid_for };
var asm = createWasm();
var ___wasm_call_ctors = function () { return (___wasm_call_ctors = Module["asm"]["E"]).apply(null, arguments); };
var _keygen = Module["_keygen"] = function () { return (_keygen = Module["_keygen"] = Module["asm"]["G"]).apply(null, arguments); };
var _encrypt = Module["_encrypt"] = function () { return (_encrypt = Module["_encrypt"] = Module["asm"]["H"]).apply(null, arguments); };
var _reencrypt = Module["_reencrypt"] = function () { return (_reencrypt = Module["_reencrypt"] = Module["asm"]["I"]).apply(null, arguments); };
var _decrypt = Module["_decrypt"] = function () { return (_decrypt = Module["_decrypt"] = Module["asm"]["J"]).apply(null, arguments); };
var _free_cptr = Module["_free_cptr"] = function () { return (_free_cptr = Module["_free_cptr"] = Module["asm"]["K"]).apply(null, arguments); };
...
var _free = Module["_free"] = function () { return (_free = Module["_free"] = Module["asm"]["N"]).apply(null, arguments); };
...
var _ntohs = function () { return (_ntohs = Module["asm"]["ntohs"]).apply(null, arguments); };
var _setThrew = function () { return (_setThrew = Module["asm"]["O"]).apply(null, arguments); };
var setTempRet0 = function () { return (setTempRet0 = Module["asm"]["P"]).apply(null, arguments); };
var stackSave = function () { return (stackSave = Module["asm"]["Q"]).apply(null, arguments); };
var stackRestore = function () { return (stackRestore = Module["asm"]["R"]).apply(null, arguments); };
var stackAlloc = function () { return (stackAlloc = Module["asm"]["S"]).apply(null, arguments); };
var ___cxa_free_exception = function () { return (___cxa_free_exception = Module["asm"]["T"]).apply(null, arguments); };
var ___cxa_can_catch = function () { return (___cxa_can_catch = Module["asm"]["U"]).apply(null, arguments); };
var ___cxa_is_pointer_type = function () { return (___cxa_is_pointer_type = Module["asm"]["V"]).apply(null, arguments); };
...
function invoke_dii(index, a1, a2) { var sp = stackSave(); try {
    return getWasmTableEntry(index)(a1, a2);
}
catch (e) {
    stackRestore(sp);
...
function callMain(args = []) { var entryFunction = _main; args.unshift(thisProgram); var argc = args.length; var argv = stackAlloc((argc + 1) * 4); var argv_ptr = argv >> 2; args.forEach(arg => { HEAP32[argv_ptr++] = allocateUTF8OnStack(arg); }); HEAP32[argv_ptr] = 0; try {
